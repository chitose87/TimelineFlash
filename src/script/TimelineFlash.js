...
(function (timelineFlash) {
    ...
    Style.color_main = Color.number(0xBBBBBB);
...
(function (timelineFlash) {
    var PropertyView = (function (_super) {
        ...
        function PropertyView(jq) {
            var _this = _super.call(this, jq.append(PropertyView.TEMPLATE)) || this;
            _this.scrollView = new timelineFlash.View(_this.jq.find(".scrollView"));
            $(window)
    ...
    var PropertyElementView = (function (_super) {
        ...
        function PropertyElementView(jq) {
            var _this = _super.call(this, jq) || this;
            _this.jq.on("change", "input", function (e) {
                var target = $(e.target);
...
(function (timelineFlash) {
    var MenuBarView = (function (_super) {
        ...
        function MenuBarView(jq) {
            var _this = _super.call(this, jq.append(MenuBarView.TEMPLATE)) || this;
            _this.jq.on("click", ".exportBtn", function () {
...
(function (timelineFlash) {
    var Panel = (function (_super) {
        ...
        function Panel() {
            ...
            _this.uid = $("body").data("id");
            $("body").append(_this.jq);
            console.log("Panel");
            Panel.instance = _this;
            _this.menuBarView = new timelineFlash.MenuBarView(_this.jq.find(".MenuBarView"));
            _this.propertyView = new timelineFlash.PropertyView(_this.jq.find(".PropertyView"));
            _this.timelinesView = new timelineFlash.View(_this.jq.find(".timelinesView"));
            //
            $(window).on("resize", function () { return _this.resize(); });
            _this.resize();
            window.opener["TimelineFlash"].instance.connect(_this);
            _this.timelines = window.opener["TimelineFlash"].instance.timelines;
            console.log(_this.timelines);
            for (var i in _this.timelines) {
                console.log(i, _this.timelines[i]);
                _this.add(_this.timelines[i]);
            }
            _this.update();
            return _this;
        }
...
(function (timelineFlash) {
    var TimelineView = (function (_super) {
        ...
        function TimelineView(timeline) {
            var _this = _super.call(this, $(TimelineView.TEMPLATE)) || this;
            _this.timeline = timeline;
            _this.labelsView = new timelineFlash.View(_this.jq.find(".labelsView"));
            _this.timelineLabelView = new timelineFlash.View(_this.jq.find(".timelineLabelView"));
            _this.scrollView = new timelineFlash.View(_this.jq.find(".scrollView"));
            _this.rulerView = new timelineFlash.RulerView(_this.jq.find(".RulerView"));
            _this.toolBarView = new timelineFlash.ToolBarView(_this.jq.find(".toolBarView"));
            _this.tweensView = new timelineFlash.View(_this.jq.find(".tweensView"));
            _this.seekBarView = new timelineFlash.View(_this.jq.find(".seekBarView"));
            _this.playBtn = new timelineFlash.View(_this.jq.find(".playBtn"));
            _this.stopBtn = new timelineFlash.View(_this.jq.find(".stopBtn"));
            //
            _this.createTweenLine(_this.timeline["_first"]);
            // events
            var _onStart = _this._onStart = _this.timeline["_onStart"];
            var _onUpdate = _this._onUpdate = _this.timeline["_onUpdate"];
            var _onComplete = _this._onComplete = _this.timeline["_onComplete"];
            _this.timeline
            ...
            _this.playBtn.jq.on("click", function () {
                console.log("playBtn");
                _this.timeline.play();
            });
            _this.stopBtn.jq.on("click", function () {
...
(function (timelineFlash) {
    var ToolBarView = (function (_super) {
        ...
        function ToolBarView(jq) {
            var _this = _super.call(this, jq.append(ToolBarView.TEMPLATE)) || this;
            _this.addTweenBtn = _this.jq.find(".addTweenBtn")
                .on("click", function () {
            });
            _this.removeTweenBtn = _this.jq.find(".removeTweenBtn")
                .on("click", function () {
            });
            return _this;
        }
...
(function (timelineFlash) {
    var TweenView = (function (_super) {
        ...
        function TweenView(tween) {
            var _this = _super.call(this, $(TweenView.TEMPLATE)) || this;
            _this.tween = tween;
            //
            _this.frameView = new FrameView(_this.jq.find(".FrameView"));
            _this.labelView = new timelineFlash.View($(TweenView.LABEL_TEMPLATE));
            //
            // set method
            var varsObj = _this.tween.vars;
            if (varsObj.runBackwards && varsObj.immediateRender) {
                _this.methodType = "from";
            }
            else if (varsObj.startAt) {
                _this.methodType = "fromTo";
            }
            else if (_this.tween.duration() == 0 && varsObj.immediateRender == false) {
                _this.methodType = "set";
            }
            else {
                _this.methodType = "to";
            }
            _this.jq.attr("data-method", _this.methodType);
            _this.labelView.jq.attr("data-method", _this.methodType);
            //
            _this.setAction();
            _this.setLabel();
            _this.update();
    ...
    var FrameView = (function (_super) {
        ...
        function FrameView(jq) {
            var _this = _super.call(this, jq.append(FrameView.TEMPLATE)) || this;
            _this.leftNobView = new timelineFlash.View(_this.jq.find(".leftNobView"));
            _this.rightNobView = new timelineFlash.View(_this.jq.find(".rightNobView"));
            return _this;
        }
        return FrameView;
    }(timelineFlash.View));
    ...
    timelineFlash.FrameView = FrameView;
})(timelineFlash || (timelineFlash = {}));
